                  ...
                  <section class="content">                  
                    <%
                        ...
                        ldia = di.ListadoDiarios(cn.conectar());
                            ...
                            out.print("<h2 class='bg-blue-active text-white text-center'> POLITICA </h2>");
                            out.print("<div class='row panel_modulos'>");

                            for (int canes = 0; canes < ldepo.getRowCount(); canes++) {
                                for (int h = 0; h < di.CantidadDiarios(); h++) {
                                    if (ldia.getValueAt(h, 3).equals(ldepo.getValueAt(canes, 0)) && (ldepo.getValueAt(canes, 0).equals("02")) ) {
